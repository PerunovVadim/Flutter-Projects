...
class _MainScreenState extends State<MainScreen>{
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Перунов Вадим Дмитриевич ИВТ-22'),actions: [IconButton(
      icon: const Icon(Icons.import_contacts),
      onPressed: () {
        Navigator.push(context, MaterialPageRoute(builder: (context) => HistoryScreenProvider()));
      },
    ),],),
